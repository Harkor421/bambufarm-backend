...
class MqttPrinterService {
        ...
        try {
          ...
          const conn = new PrinterMqttConnection({
            ...
            onStateChange: async (devId, state, prevGcodeState) => {
              ...
              eventBus.emit(EVENTS.PRINTER_STATE_CHANGE, { bambuUid, devId, state, prev: prevGcodeState });
  ...
  async _handleStateChange(user, devId, state, prevGcodeState, _skipPushToStart = false, printerNames = {}) {
